<template>
  <div class="grid__row">
      <div class="grid__column-8">
          <div class="job-detail__top">
            ...
            <div class="job-detail__info--sections">
              <div class="job-detail__info--section">
                ...
                <div class="job-detail__info--section-content">
                  ...
                  <div class="job-detail__info--section-content-value">{{ jobdetail?.Salary}}</div>
                </div>
              </div>
              <div class="job-detail__info--section">
                <div class="job-detail__info--section-icon">
                ...
                <div class="job-detail__info--section-content">
                  ...
                  <div class="job-detail__info--section-content-value">{{ jobdetail?.Level}}</div>
                </div>
              </div>
              <div class="job-detail__info--section">
                <div class="job-detail__info--section-icon">
                ...
                <div class="job-detail__info--section-content">
                  ...
                  <div class="job-detail__info--section-content-value">{{ jobdetail?.YOE}}</div>
                </div>
              </div>
            </div>
            ...
            <div class="job-detail__info--sections">
              <div class="job-detail__info--section">
                ...
                <div class="job-detail__info--section-content">
                  <div class="job-detail__info--section-content-title">Giới tính</div>
                  <div class="job-detail__info--section-content-value">{{ jobdetail?.Sex}}</div>
                </div>
              </div>
              <div class="job-detail__info--section">
                <div class="job-detail__info--section-icon">
              ...
              <div class="job-detail__info--section">
                ...
                <div class="job-detail__info--section-content">
                  <div class="job-detail__info--section-content-title">Học vấn</div>
                  <div class="job-detail__info--section-content-value">{{ jobdetail?.Education}}</div>
                </div>
              </div>
            </div>
            <div class="job-detail__info--times-content">
              <div class="job-detail__info--times">
                <div class="job-detail__info--time">Ngày đăng: {{ jobdetail?.Posting_date}}</div>
          ...
          <div class="job-detail__bottom">
            <h2 class="job-detail__bottom--title">Chi tiết tuyển dụng</h2>
            <div class="job-detail__bottom--content">
              <div class="job-detail__bottom--description">
                <div class="job-detail__bottom--description-item">
                  ...
                  <p v-html = "formatTextSkill(jobdetail?.Describe_job)"></p>
                </div>
              </div>
            </div>
            <div class="job-detail__bottom--content">
            ...
            <div class="job-detail__bottom--content">
              <div class="job-detail__bottom--description">
                <div class="job-detail__bottom--description-item">
                  ...
                  <p v-html = "formatTextSkill(jobdetail?.Location)"></p>
                </div>
              </div>
            </div>
            <div class="job-detail__bottom--content">
              <div class="job-detail__bottom--description">
                <div class="job-detail__bottom--description-item">
                  <h2>Lợi ích</h2>
                  <p v-html = "formatTextSkill(jobdetail?.Benefits)"></p>
                </div>
              </div>
            </div>
          </div>
...
.job-detail__info--section-icon {
    align-items: center;
    background: linear-gradient(11deg,#0355cd,#438ad6);
    border-radius: 30px;
    display: flex;
    flex-direction: column;
    gap: 10px;
...
.job-detail__info--section-icon svg{
  flex-shrink: 0;
    height: 24px;
    width: 24px;
}
...
.job-detail__top, .job-detail__bottom{
  display: flex;
  flex-direction: column;
  gap: 16px;
...
.job-detail__bottom--title{
  border-left: 6px solid #0355cd;
  color: #212f3f;
  font-size: 20px;
  font-style: normal;
  font-weight: 700;
...
.job-detail__bottom--content, .job-detail__bottom--description{
  display: flex;
  flex-direction: column;
  gap: 16px;
}
.job-detail__bottom--description-item{
  display: flex;
  flex-direction: column;
  gap: 8px;
  
}
.job-detail__bottom--description-item h2{
  color: #212f3f;
    font-size: 16px;
    font-style: normal;
    font-weight: 600;
...
.button-back button, .job-detail__info--button button{
  padding: 10px 20px;
...
.button-back button:hover, .job-detail__info--button button:hover {
  background-color: #07379e ;
}
.job-detail__info--times-content{
  display: flex;
  gap: 50%;
  justify-content: space-around;
}
.job-detail__info--button{
  margin-right: 45px;
  margin-top: 10px;
}
</style>